...
typedef struct s_bresenham_state
{
	...
	float		color_r_delta;	// red channel increment (float 0..1)
	float		color_g_delta;	// green channel increment (float 0..1)
	float		color_b_delta;	// blue channel increment (float 0..1)
}	t_bresenham_state;
...
typedef struct s_app
{
	...
	int					(*edges)[2];		// edge list: n_edges x 2 indices
