...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/29 22:59:21 by dlesieur          #+#    #+#             */
/*   Updated: 2025/08/29 22:59:22 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void						matrix4_multiply(const float *a, const float *b,
								float *out);
...
void						handle_key_event(int keycode,
								unsigned int modifiers, t_app *fdf);
void						event_system_init(t_app *fdf);

/*
 * RENDER
 */
void						render_string(char *str, uint32_t *buf,
								int x, int y);
 ...
 * PARSE INPUT
 */
bool						parse_chunk(t_parser *p, t_app *fdf,
								size_t chunk_size);
bool						realloc_all(t_parser *p, t_app *fdf);
bool						parse_color(t_parser *p,
								size_t chunk_size, size_t *i);
...
void						matrix4_translate(float *m, float delta_x,
...
void						trans_stack_ortho(t_trans_stack *t, float x,
								float y, float z);
void						trans_stack_zoom(t_trans_stack *t, int direction);
void						trans_stack_translate(t_trans_stack *t, float dx,
								float dy, float dz);
void						trans_stack_pan(t_trans_stack *t,
								float dx, float dy);
void						trans_stack_origin(t_trans_stack *t, float dx,
								float dy, float dz);
void						center_model(t_trans_stack *t, float width,
...
extern void					palette_terrain_2(int *arr,
								int pos, int z_value);
extern void					palette_gamma_2(int *arr, int pos,
								int z_value);
extern void					pallete_gamma_random_2(int *arr,
								int pos, int z_value);
...
void						apply_auto_trackball_rotation(t_app *fdf,
 ...
 */
int							trackball_button_press_handler(int button,
								int x, int y, t_app *fdf);
int							trackball_button_release_handler(int button,
								int x, int y, t_app *fdf);
int							trackball_motion_handler(int x, int y,
								t_app *fdf);
int							trackball_key_press_handler(int keycode,
								t_app *fdf);

/*
 * SHADOW EFFECTS
 */
void						apply_shadow_effects(t_app *fdf,
								bool depth_shadows, bool ambient_shadows);
...
int							z_perspective_key_press_handler(int keycode,
								t_app *fdf);
int							z_perspective_key_release_handler(int keycode,
								t_app *fdf);
...
void						register_event_binding(int keycode,
								unsigned int modifiers, t_event_fn handler);
t_event_fn					find_event_handler(int keycode,
...
void						move_up(t_app *fdf,
								int keycode, void *data);
void						move_down(t_app *fdf,
								int keycode, void *data);
void						move_left(t_app *fdf,
								int keycode, void *data);
void						move_right(t_app *fdf,
								int keycode, void *data);
void						rotate_up_handler(t_app *fdf,
								int keycode, void *data);
void						rotate_down_handler(t_app *fdf,
								int keycode, void *data);
void						rotate_left_handler(t_app *fdf,
								int keycode, void *data);
void						rotate_right_handler(t_app *fdf,
								int keycode, void *data);
void						zoom_in(t_app *fdf,
								int keycode, void *data);
void						zoom_out(t_app *fdf,
								int keycode, void *data);
void						projection_iso(t_app *fdf,
								int keycode, void *data);
void						projection_fly(t_app *fdf,
								int keycode, void *data);
void						ch_shape(t_app *fdf,
								int keycode, void *data);
void						exit_prog(t_app *fdf,
								int keycode, void *data);
void						reset_state(t_app *fdf,
								int keycode, void *data);
void						project_iso(t_app *fdf,
								int keycode, void *data);
void						mouse_right(t_app *fdf,
								int keycode, void *data);
void						mouse_left(t_app *fdf,
								int keycode, void *data);
void						scroll_mouse(t_app *fdf,
								int keycode, void *data);
void						z_perspective_ctrl(t_app *fdf,
								int keycode, void *data);
void						auto_rotate(t_app *fdf,
								int keycode, void *data);

// Color palette handlers for keys 1-9
void						palette_1_handler(t_app *fdf,
								int keycode, void *data);
void						palette_2_handler(t_app *fdf,
								int keycode, void *data);
void						palette_3_handler(t_app *fdf,
								int keycode, void *data);
void						palette_4_handler(t_app *fdf,
								int keycode, void *data);
void						palette_5_handler(t_app *fdf,
								int keycode, void *data);
void						palette_6_handler(t_app *fdf,
								int keycode, void *data);
void						palette_7_handler(t_app *fdf,
								int keycode, void *data);
void						palette_8_handler(t_app *fdf,
								int keycode, void *data);
void						palette_9_handler(t_app *fdf,
								int keycode, void *data);
...
//SWITCH EVENTS - Updated signatures with keycode parameter
void						dynamic_background_toggle_handler(t_app *fdf,
								int keycode, void *data);
void						apply_stars_particles(t_app *fdf);
void						apply_bubbles_particles(t_app *fdf);
void						apply_dust_particles(t_app *fdf);
...
uint32_t					blend_colors(uint32_t base_color,
								uint32_t texture_color, float blend_factor);
...
void						update_z_perspective(t_app *fdf,
								float scale_change);
float						calculate_wobble_component(float freq,
								float multiplier,
								float scale);
float						calculate_wobble_axis(float freq,
								float *multipliers,
								float *scales);
...
void						lightning_draw(uint32_t *b,
								int sx, int ex, float fade);
...
int							accumulate_hex(uint32_t *acc,
								char *cur, char *end, int *digits);
...
void						dance_toggle_handler(t_app *fdf,
								int keycode, void *data);
...
void						heart_lower_point(float s,
								t_fpoint2 n, t_fpoint3 *o);
void						heart_upper_lobes(float s,
								t_fpoint2 n, t_fpoint3 *o);
