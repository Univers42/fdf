...
/*   Updated: 2025/08/31 16:14:09 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Computes the chips shape position.
 *
 * Maps the grid point to a position on a hyperbolic paraboloid surface.
 *
...
/**
 * @brief Computes the wave shape position.
 *
 * Maps the grid point to a position on a wavy surface using sine
